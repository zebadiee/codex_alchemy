...
from codex_alchemy.rituals.diff import diff_sigils
from codex_alchemy.debugger import debug  # ✅ This is the debug command
...
# ✅ Register the debug command AFTER cli is defined
...
@vault.command("diff")
@click.argument("sigil_a")
@click.argument("sigil_b")
def vault_diff(sigil_a, sigil_b):
    """Diff two sigils in the vault."""
    diff_sigils(sigil_a, sigil_b)
