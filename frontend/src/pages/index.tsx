      ...
      <Container maxWidth="md" sx={{ mt: 8 }}>
        ...
        <Box mt={4} display="flex" gap={2} flexWrap="wrap">
          ...
          <Link href="/a0-integration" passHref legacyBehavior>
            <Button variant="contained" color="secondary">A0 Integration</Button>
          </Link>
          <Link href="/glyphcyclopedia" passHref legacyBehavior>
            <Button variant="contained" color="success">🔮 Glyphcyclopedia</Button>
          </Link>
          <Link href="/debug" passHref legacyBehavior>
            <Button variant="outlined" color="secondary">Debug</Button>
          </Link>
